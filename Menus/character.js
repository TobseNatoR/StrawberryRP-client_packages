...
function fillHairMenu() {
    hairItem = new UIMenuListItem("Haare", "Deine Haare.", new ItemsCollection(Data.hairList[currentGender].map(h => h.Name)));
    ...
    hairHighlightItem = new UIMenuListItem("Haarfarbe hervorheben", "Deine Haarfarbe hervorheben.", new ItemsCollection(hairColors));
    ...
    beardColorItem = new UIMenuListItem("Gesichtshaarfarbe", "Deine Gesichtshaarfarbe.", new ItemsCollection(hairColors));
    creatorHairMenu.AddItem(beardColorItem);

    eyeColorItem = new UIMenuListItem("Augenfarbe", "Deine Augenfarbe.", new ItemsCollection(Data.eyeColors));
    creatorHairMenu.AddItem(eyeColorItem);

    blushColorItem = new UIMenuListItem("Farbe erröten", "Deine Farbe erröten.", new ItemsCollection(blushColors));
    ...
    chestHairColorItem = new UIMenuListItem("Brust Haarfarbe", "Deine Brust Haarfarbe.", new ItemsCollection(hairColors));
    creatorHairMenu.AddItem(chestHairColorItem);

    creatorHairMenu.AddItem(new UIMenuItem("Random", "~r~Haare & Farben random."));
    creatorHairMenu.AddItem(new UIMenuItem("Reset", "~r~Haare & Farben resetten."));
}
...
// CREATOR MAIN
let creatorMainMenu = new Menu("Charactererstellung", "", new Point(50, 50));
let genderItem = new UIMenuListItem("Geschlecht", "~r~Wenn du das änderst wird dein Skin zurückgesetzt..", new ItemsCollection(["Mann", "Frau"]));
creatorMainMenu.AddItem(genderItem);
creatorMainMenu.AddItem(new UIMenuItem("Eltern", "Wähle deine Eltern"));
creatorMainMenu.AddItem(new UIMenuItem("Features", "Wähle deine Gesichtsfeatures."));
creatorMainMenu.AddItem(new UIMenuItem("Aussehen", "Dein Aussehen."));
creatorMainMenu.AddItem(new UIMenuItem("Haar & Farben", "Deine Haare und deine Haarfarbe."));
...
let saveItem = new UIMenuItem("Speichern", "Speichere alle Änderungen.");
saveItem.BackColor = new Color(13, 71, 161);
saveItem.HighlightedBackColor = new Color(25, 118, 210);
creatorMainMenu.AddItem(saveItem);

let cancelItem = new UIMenuItem("Abbrechen", "Alle Änderungen verwerfen.");
